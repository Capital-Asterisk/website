...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'birdstrike.data';
      var REMOTE_PACKAGE_BASE = 'birdstrike.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_birdstrike.data');

      };
      Module['addRunDependency']('datafile_birdstrike.data');
    ...
    loadPackage({"files": [{"filename": "/dummy.txt", "start": 0, "end": 2}], "remote_package_size": 2});
...
var wasmBinaryFile;
  wasmBinaryFile = 'birdstrike.wasm';
